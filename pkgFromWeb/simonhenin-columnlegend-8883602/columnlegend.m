...
%         set(legend_h, 'position', [fig_pos(1)+fig_pos(3)/2-pos(3)/2 fig_pos(2)+fig_pos(4)-pos(4) pos(3) pos(4)]);
%         set(legend_h, 'position', [fig_pos(1) fig_pos(2)+fig_pos(4)-3*pos(4)/9+0.01 pos(3) pos(4)]); % for chapter 4
        set(legend_h, 'position', [fig_pos(1)-0.08 fig_pos(2)+fig_pos(4)-3*pos(4)/9+0.01 pos(3) pos(4)]); % for chapter 5
%         set(legend_h, 'position', [fig_pos(1)-0.08 fig_pos(2)+fig_pos(4)-3*pos(4)/9-0.05 pos(3) pos(4)]); % for chapter 5 plus
%         set(legend_h, 'position', [fig_pos(1)-0.08 fig_pos(2)+fig_pos(4)-3*pos(4)/9-0.02 pos(3) pos(4)]); % for fig 5.10
...
%     set(legend_h, 'units', 'normalized');
    ...
    annotation('rectangle',pos, 'Linewidth', 0.283)
end
