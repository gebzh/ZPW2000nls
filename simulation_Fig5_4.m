%% simulation of Fig 5.4 the comparison of accuracies of different algs
        ...
        for q = 1:18
            ...
            for k = 1:times
                ...
                if (abs(f0_hat-f0)>0.5 || abs(f1_hat-f1)>0.5)
                    fprintf('Td = %fs£¨‘ÿ∆µ°¢µÕ∆µŒ™%f Hz°¢%f Hz ±£¨YF≥ˆœ÷“Î¬Î¥ÌŒÛ£°\n',...
                        Td,f0,f1);
            ...
            for k = 1:times
                ...
                if (abs(f0_hat-f0)>0.5 || abs(f1_hat-f1)>0.5)
                    fprintf('Td = %fs£¨‘ÿ∆µ°¢µÕ∆µŒ™%f Hz°¢%f Hz ±£¨EA≥ˆœ÷“Î¬Î¥ÌŒÛ£°\n',...
                        Td,f0,f1);
            ...
            for k = 1:times
                ...
                if (abs(f0_hat-f0)>0.5 || abs(f1_hat-f1)>0.5)
                    fprintf('Td = %fs£¨‘ÿ∆µ°¢µÕ∆µŒ™%f Hz°¢%f Hz ±£¨NLSM≥ˆœ÷“Î¬Î¥ÌŒÛ£°\n',...
                        Td,f0,f1);
            ...
            for k = 1:times
                ...
                if (abs(f0_hat-f0)>0.5 || abs(f1_hat-f1)>0.5)
                    fprintf('Td = %fs£¨‘ÿ∆µ°¢µÕ∆µŒ™%f Hz°¢%f Hz ±£¨rRELAX≥ˆœ÷“Î¬Î¥ÌŒÛ£°\n',...
                        Td,f0,f1);
...
save(strcat(pwd,'/data_files/Fig 5_4 simulation results.mat'),...
'Tds','f0_mse','f1_mse','errorcount','crbappf0','crbappf1','crbsimf0','crbsimf1');
