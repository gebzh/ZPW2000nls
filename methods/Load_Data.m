function [ ] = Load_Data( N,fs )
% 1. calculating the parameters which is irrelevant to the received signal and
% is concurrently related to the demodulation process.
% 2. loading these parameters into the memory as global variables  
% hint: this function is written in accordance to the patent
%   inputs:
